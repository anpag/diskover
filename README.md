# diskover-private - File system crawler, disk space usage, file search engine and storage analytics powered by Elasticsearch, without the callbacks!
...
I hate callbacks. I like privacy. This is a fork I will try to maintain that doesn't have the callbacks added in the latest release of diskover.
...
**diskover-private requires NO AUTH TOKEN \o/**
